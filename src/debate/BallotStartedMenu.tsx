...
export const BallotStartedMenu = () => (
  <>
    ...
    <div className="sidenote">
      ...
      <Timer initialDuration={4} />
      <h6 className="bigger centeralign semibold">Academy NB Prep</h6>
      <Timer initialDuration={3} />
      <h6 className="bigger centeralign semibold">Williams GB Prep</h6>
      <Timer initialDuration={3} />
    </div>
  </>
);
